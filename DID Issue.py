...
print("-------------------------------------------------------------------------")
print("\nStudent's publicKey: ",student_pubkey)
print("Student's signature: ",student_signature)
print("\nIssuer's publicKey: ",issuer_pubkey)
print("Issuer's signature: ",issuer_signature)
print("-------------------------------------------------------------------------")
while True:
    hold=1
