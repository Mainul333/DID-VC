...
issuer_privkey="9cfd7c145093239ad8ea8b6b0797332b46da4fc1a2f7280eb86b533138d0511d"
issuer_pubkey="a76f23be037469be7f6af21c4fcd25f0ae78407dc5c27835e2240adfdc906833"
...
for i in range(VC_count):
    start_time=time.time()
    with open('VC.json', 'r') as file:
        data = json.load(file)
    issuer_signature=sign(bytes.fromhex(issuer_privkey),(str(data['@context'])+str(data['issuer'])+str(data['subject'])).strip()).hex()
    ...
    print("VC issuance latency-",i,":",int(elapsed_time*1000)/1000," seconds")
with open('VC_Issuance_Time.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
print("Average latency required to issue VC:",int(total_time*1000/VC_count)/1000," seconds")
