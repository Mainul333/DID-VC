...
# print(b58decode2(b58encode2("75bfab0b5a43a1ab46370b97d49da713eaee19636c2ff847fe62efa81a6dd285"))) 
student_privkey="39236ac339d6a38db1e11e9e1b4351f7ec98a24d8bcd1513120da635b2054fcf"
student_pubkey="75bfab0b5a43a1ab46370b97d49da713eaee19636c2ff847fe62efa81a6dd285"
issuer_privkey="44ff3d6b8578f0d78c96c8335de7b687a655d6cd88f28c79d3e93b8e48ce6618"
issuer_pubkey="9d45579de90a05d9a91cabab4cd379b1c2ac3cf7771fd9555ae87eadc48a0a81"
total_time=0
DID_count=1000
issuance_time=[]
...
for i in range(DID_count):
    ...
    with open('DID.json', 'r') as file:
        data = json.load(file)
    student_signature=sign(bytes.fromhex(student_privkey),str(data['student']).strip()).hex()
    data['authentication']['signature']=student_signature
    issuer_signature=sign(bytes.fromhex(issuer_privkey),(str(data['@context'])+str(data['issuer'])+str(data['student'])+str(data['authentication'])).strip()).hex()
    data['proof']['signature']=issuer_signature
    with open("DID.json", "w") as outfile:
        json.dump(data, outfile, indent=4)
    end_time=time.time()
    elapsed_time=end_time-start_time
    total_time=total_time+elapsed_time
    issuance_time.append([i,elapsed_time])
    print("DID issuance latency-",i,":",int(elapsed_time*1000)/1000," seconds")
    
with open('DID_Issuance_Time.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
    ...
    # write multiple rows
    writer.writerows(issuance_time)
print("Average latency required to issue DID:",int(total_time*1000/DID_count)/1000," seconds")
